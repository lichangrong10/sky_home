        ...
        <div className="hidden sm:block">
          <FadeIn delay={0.3} y={40}>
            <Magnet padding={100} strength={2.5} className="absolute left-[4%] md:left-[5%] bottom-[40%] md:bottom-[36%] z-10 w-[180px] md:w-[270px] lg:w-[350px]">
              <img src={img("/jllll.png")} alt="" className="w-full h-auto pointer-events-none select-none rounded-[20px] shadow-lg shadow-black/30" draggable={false} loading="lazy" />
            </Magnet>
          </FadeIn>
          <FadeIn delay={0.45} y={40}>
            <Magnet padding={80} strength={2} className="absolute left-[24%] md:left-[26%] lg:left-[28%] bottom-[22%] md:bottom-[18%] z-10 w-[120px] md:w-[170px] lg:w-[220px]">
              <img src={img("/16.jpg")} alt="" className="w-full h-auto pointer-events-none select-none rounded-[20px] shadow-lg shadow-black/30" draggable={false} loading="lazy" />
            </Magnet>
          </FadeIn>
          <FadeIn delay={0.6} y={30}>
            <Magnet padding={150} strength={3} className="absolute left-1/2 -translate-x-1/2 bottom-[10%] md:bottom-[8%] z-10 w-[360px] md:w-[440px] lg:w-[520px]">
              <img src={img("/1.jpg")} alt="Jack Portrait" className="w-full h-auto pointer-events-none select-none rounded-[20px] shadow-lg shadow-black/30" draggable={false} />
            </Magnet>
          </FadeIn>
        </div>
